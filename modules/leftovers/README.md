...
module/log and unreferenced-receipt evidence, or caller-supplied fixture
evidence, into the shared path-free finding contract.
...
The core live adapter inspects only runtime.zero's own module, log, and
unreferenced receipt roots. Receipt ownership is checked only when the
installed-module registry is valid; an invalid registry makes that source
unavailable rather than guessing. It rejects root symlinks, skips descendant
