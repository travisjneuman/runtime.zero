...
| `leftovers --dry-run` | No | No | Bounded runtime.zero-owned module/log review; no quarantine authority |
| `integrity --dry-run` | No | No | Strict fixture-only digest review; no trusted baseline or remediation |
