...
| `updates --all-providers` | Manager may read remote metadata after acknowledgement | No product write | Bounded macOS review; missing and uncovered sources remain warnings |
