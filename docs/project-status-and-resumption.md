...
- **Reviewed source baseline:**
  `39adb92` (`Add Windows job-contained process host`).
- **Current behavior implementation:**
  `39adb92` on `main`, including the redesigned TUI, Rust toolchain contract,
  ...
  and independent portable-package verification.
- **CLI version:** `0.1.0`.
...
the Windows process-host/probe slice at `39adb92`. Local `main` and
