...
| Cache management | Required | Required | Required | Bounded known-root read-only evidence plus one exact runtime-cache-file plan/apply lane; manager/user/shared ownership, retention, and platform parity remain open |
